...
<article class="bg-white rounded-2xl p-8 flex flex-col gap-4">
    ...
    <div class="leading-relaxed text-justify">
        ...
        convallis quis consequat at, porta non nisi.</p>
        <br>
        <p>Vestibulum ultrices nisl ac elementum finibus. Nullam fermentum consequat dui, quis imperdiet
        magna aliquam at. Phasellus id augue vehicula, condimentum tortor a, aliquam lectus. Fusce
        aliquet egestas tortor.</p>
    </div>
</article>
